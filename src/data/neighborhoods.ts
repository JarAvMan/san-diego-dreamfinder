...
export const sandiegoNeighborhoods: Neighborhood[] = [
  ...
  },
  {
    id: 'solana-beach',
    name: 'Solana Beach',
    description: 'A coastal community with blufftop homes, beach access, and the Cedros Design District. Solana Beach offers a relaxed atmosphere with upscale shopping
